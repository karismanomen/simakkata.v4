                ...
                <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <label for="nama_aplikasi" class="col-lg-2 control-label">Nama Aplikasi</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label for="alamat" class="col-lg-2 control-label">Alamat Instansi</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label for="path_logo" class="col-lg-2 control-label">Foto</label>
                            <div class="col-lg-4">
        ...
        function showData() {
            $.get('{{ route('setting.show') }}')
                .done(response => {
                    ...
                    let words = response.nama_aplikasi.split(' ');
                    let word = '';
                    words.forEach(w => {
                        word += w.charAt(0);
                    });
                    $('.logo-mini').text(word);
                    $('.logo-lg').text(response.nama_aplikasi);
